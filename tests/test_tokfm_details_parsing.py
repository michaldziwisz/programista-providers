...
from programista_providers_radio.tokfm import parse_tokfm_details_html  # noqa: E402


class TestTokFmDetailsParsing(unittest.TestCase):
    def test_prefers_og_description_when_meta_is_truncated(self) -> None:
        html = """
        <html><head>
          <meta name="description" content="Podcast ... Ziobr">
          <meta property="og:description" content="Podcast ... Ziobry.">
        </head><body></body></html>
        """
        self.assertEqual(parse_tokfm_details_html(html), "Podcast ... Ziobry.")
    ...
    def test_falls_back_to_meta_description(self) -> None:
        ...
        """
        self.assertEqual(parse_tokfm_details_html(html), "Full meta description")
